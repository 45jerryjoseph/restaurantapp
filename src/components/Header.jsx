                            ...
                            className =" w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0">
                                {
                                    user && user.email === "45jerryjoseph@gmail.com" &&(
                                        <Link to ={'/createItem'}>
                                            <p className =" px-4 py-2 flex items-center gap-3 hover:bg-slate-100 transition-all duration-100 ease-in-out text-textcolor text-base">New Item <MdAdd /></p>
                                        </Link>
                                    )
                                }
                        ...
                        isMenu &&(
                            ...
                            className =" w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0">
                                ...
                                <ul className=' flex flex-col '>
                                    ...
                                    <li className=' text-base text-textcolor hover:text-headingColor duration-100 transition-all ease-in-out  cursor-pointer hover:bg-slate-100 px-4 py-2'>Services</li>
                                </ul>
